...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Math.Extrapolate</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Math.Extrapolate</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_math_extrapolate.js.html">extrapolate.js</a>.
...
<!-- ============================== constructor summary ==================== -->
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Math.Extrapolate.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Extrapolate.html#constructor">JXG.Math.Extrapolate</a></b>
							</div>
							<div class="description">Functions for extrapolation of sequences.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Math.Extrapolate.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Extrapolate.<b><a href="../symbols/JXG.Math.Extrapolate.html#.aitken">aitken</a></b>(s_n, n, a)
								</div>
								<div class="description">Aitken transformation.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Extrapolate.<b><a href="../symbols/JXG.Math.Extrapolate.html#.brezinski">brezinski</a></b>(s_n, n, a)
								</div>
								<div class="description">Iterated Brezinski transformation.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Extrapolate.<b><a href="../symbols/JXG.Math.Extrapolate.html#.iteration">iteration</a></b>(x0, h0, f, method, step_type)
								</div>
								<div class="description">Extrapolated iteration to approximate the value f(x_0).</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Extrapolate.<b><a href="../symbols/JXG.Math.Extrapolate.html#.levin">levin</a></b>(s_n, n, numer, denom, numer, denom)
								</div>
								<div class="description">Levin transformation.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Extrapolate.<b><a href="../symbols/JXG.Math.Extrapolate.html#.limit">limit</a></b>(x0, h0, f)
								</div>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Extrapolate.<b><a href="../symbols/JXG.Math.Extrapolate.html#.wynnEps">wynnEps</a></b>(s_n, n, e)
								</div>
								<div class="description">Wynn's epsilon algorithm.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.Math.Extrapolate.</span><b>aitken</b>(s_n, n, a)
...
and the summation of divergent series", Computer Physics Reports Vol. 10, 189-371 (1989).
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Number}</span> <b>s_n</b>
									
								</dt>
								<dd>next value of sequence, i.e. n-th element of sequence</dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>n</b>
									
								</dt>
								<dd>index of s_n in the sequence</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>a</b>
									
								</dt>
								<dd>One-dimensional array containing the extrapolation data. Has to be supplied by the calling routine.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Number}</span> New estimate of the limit of the sequence.</dd>
					...
					<span class="light">{Number}</span>
					<span class="light">JXG.Math.Extrapolate.</span><b>brezinski</b>(s_n, n, a)
...
and the summation of divergent series", Computer Physics Reports Vol. 10, 189-371 (1989).
					...
					<span class="light">JXG.Math.Extrapolate.</span><b>iteration</b>(x0, h0, f, method, step_type)
					...
					<div class="description">
						Extrapolated iteration to approximate the value f(x_0).
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Value for which the limit of f is to be determined. f(x0) may or may not exist.</dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>h0</b>
									
								</dt>
								<dd>Initial (signed) distance from x0.</dd>
							
								<dt>
									<span class="light fixedFont">{Function}</span> <b>f</b>
									
								</dt>
								<dd>Function for which the limit at x0 is to be determined</dd>
							
								<dt>
									<span class="light fixedFont">{String}</span> <b>method</b>
									
								</dt>
								<dd>String to choose the method. Available values: "wynnEps", "aitken", "brezinski"</dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>step_type</b>
									
								</dt>
								<dd>Approximation method. step_type = 0 uses the sequence x0 + h0/n; step_type = 1 uses the sequence x0 + h0 * 2^(-n)</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Array}</span> Array of length 3. Position 0: estimated value for f(x0), position 1: 'finite', 'infinite', or 'NaN'.
Position 2: value between 0 and 1 judging the reliability of the result (1: high, 0: not successful).</dd>
							...
							<dt class="heading">See:</dt>
								...
								<dd><a href="../symbols/JXG.Math.Extrapolate.html#.limit">JXG.Math.Extrapolate.limit</a></dd>
							
								<dd><a href="../symbols/JXG.Math.Extrapolate.html#.wynnEps">JXG.Math.Extrapolate.wynnEps</a></dd>
							
								<dd><a href="../symbols/JXG.Math.Extrapolate.html#.aitken">JXG.Math.Extrapolate.aitken</a></dd>
							
								<dd><a href="../symbols/JXG.Math.Extrapolate.html#.brezinski">JXG.Math.Extrapolate.brezinski</a></dd>
					...
					<span class="light">JXG.Math.Extrapolate.</span><b>levin</b>(s_n, n, numer, denom, numer, denom)
...
Not yet ready for use.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array}</span> <b>numer</b>
									
								</dt>
								<dd>One-dimensional array containing the extrapolation data for the numerator. Has to be supplied by the calling routine.</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>denom</b>
									
								</dt>
								<dd>One-dimensional array containing the extrapolation data for the denominator. Has to be supplied by the calling routine.</dd>
					...
					<span class="light">{Array}</span>
					<span class="light">JXG.Math.Extrapolate.</span><b>limit</b>(x0, h0, f)
...
In case that the extrapolation fails, position 1 and 2 contain 'direct' and 0.</dd>
							...
							<dt class="heading">See:</dt>
								...
								<dd><a href="../symbols/JXG.Math.Extrapolate.html#.iteration">JXG.Math.Extrapolate.iteration</a></dd>
					...
					<pre class="code">var f1 = (x) => Math.log(x),
...
<script type="text/javascript">
    ...
    for (let f of [f1, f2, f3]) {
        ...
        console.log(JXG.Math.Extrapolate.limit(x0, h, f));
					...
					<span class="light">{Number}</span>
					<span class="light">JXG.Math.Extrapolate.</span><b>wynnEps</b>(s_n, n, e)
...
and the summation of divergent series", Computer Physics Reports Vol. 10, 189-371 (1989).
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array}</span> <b>e</b>
