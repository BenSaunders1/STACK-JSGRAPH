...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Math.ImplicitPlot</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Math.ImplicitPlot</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_math_implicitplot.js.html">implicitplot.js</a>.
...
<!-- ============================== constructor summary ==================== -->
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Math.ImplicitPlot.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.ImplicitPlot.html#constructor">JXG.Math.ImplicitPlot</a></b>(bbox, config, f, dfx, dfy)
							</div>
							<div class="description">Plotting of curves which are given implicitly as the set of points solving an equation
<i>f(x,y) = 0</i>.</div>
						</td>
					</tr>
				</tbody>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Math.ImplicitPlot.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#curveContainsPoint">curveContainsPoint</a></b>(p, dataX, dataY, tol, eps)
								</div>
								<div class="description">Test if the data points contain a given coordinate, i.e.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#handleCriticalPoint">handleCriticalPoint</a></b>(u, t_u, r, omega)
								</div>
								<div class="description">Search in an arc around a critical point for a further point on the curve.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#isBifurcation">isBifurcation</a></b>(u, tol)
								</div>
								<div class="description">If both eigenvalues of the Hessian are different from zero, the critical point at u
is a simple bifurcation point.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#plot">plot</a></b>()
								</div>
								<div class="description">Implicit plotting method.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#searchLine">searchLine</a></b>(fmi, fma, fix, interval, dir, num_components, dataX, dataY)
								</div>
								<div class="description">Recursively search a horizontal or vertical line for points on the
fulfilling the given equation.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#tangent">tangent</a></b>(u)
								</div>
								<div class="description">Tangent of norm 1 at point u.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#tangent_A">tangent_A</a></b>(A)
								</div>
								<div class="description">Approximate tangent (of norm 1) with Quasi-Newton method</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#traceComponent">traceComponent</a></b>(u0)
								</div>
								<div class="description">Starting at an initial point the curve is traced with a Euler-Newton method.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#tracing">tracing</a></b>(u0, direction)
								</div>
								<div class="description">Starting at a point <i>u0</i>, this routine traces the curve <i>f(u)=0</i> until
a loop is detected, a critical point is reached, the curve leaves the bounding box,
or the maximum number of points is reached.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#updateA">updateA</a></b>(A, u0, u1)
								</div>
								<div class="description">Quasi-Newton update of the Moore-Penrose inverse.</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>JXG.Math.ImplicitPlot</b>(bbox, config, f, dfx, dfy)
				</div>
...
keep the construction responsive.
						...
						<dl class="detailList">
							...
							<dt>
								...
								<dd>Bounding box of the area in which solutions of the equation
are determined.</dd><br /><br />
							...
							<dt>
								...
								<dd>Configuration object. Default:
<pre>
 {
     ...
     unitY: 10             // unitX of board
							...
							<dt>
								...
								<dd>function from <b>R</b><sup>2</sup> to <b>R</b></dd><br /><br />
						
							<dt>
                                
    								<span class="light fixedFont">{function}</span>  <b>dfx</b>
	    							<i>Optional</i>
                                
                                
							</dt>
								<dd>Optional partial derivative of <i>f</i> with regard to <i>x</i></dd><br /><br />
						
							<dt>
                                
    								<span class="light fixedFont">{function}</span>  <b>dfy</b>
	    							<i>Optional</i>
                                
                                
							</dt>
								<dd>Optional partial derivative of <i>f</i> with regard to <i>y</i></dd><br /><br />
				...
				<pre class="code">    var f = (x, y) => x**3 - 2 * x * y + y**3;
...
<!-- ============================== method details ========================= -->
				...
				<div class="sectionTitle">
					...
					<a name="curveContainsPoint"> </a>
					<div class="fixedFont">

					
					<b>curveContainsPoint</b>(p, dataX, dataY, tol, eps)
...
through the data points.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Homogenous coordinates [1, x, y] of the coordinate point</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>dataX</b>
									
								</dt>
								<dd>x-coordinates of points so far</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>dataY</b>
									
								</dt>
								<dd>y-coordinates of points so far</dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>tol</b>
									
								</dt>
								<dd>Maximal distance of p from the polygonal chain through the data points</dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>eps</b>
									
								</dt>
								<dd>Helper tolerance used for the quadtree</dd>
					...
					<a name="handleCriticalPoint"> </a>
					<div class="fixedFont">&lt;private&gt; 

					<span class="light">{Array}</span>
					<b>handleCriticalPoint</b>(u, t_u, r, omega)
...
Unused for the moment.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array}</span> <b>u</b>
									
								</dt>
								<dd>Critical point [x, y]</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>t_u</b>
								...
								<dt>
									<span class="light fixedFont">{Number}</span> <b>omega</b>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Array}</span> Coordinates [x, y] of a new point.</dd>
					...
					<a name="isBifurcation"> </a>
					<div class="fixedFont">&lt;private&gt; 

					
					<b>isBifurcation</b>(u, tol)
...
is a simple bifurcation point.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Tolerance of the eigenvalues to be zero.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd>Boolean True if the point is a simple bifurcation point.</dd>
					...
					<div class="description">
						Implicit plotting method.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Array}</span> consisting of [dataX, dataY, number_of_components]</dd>
					...
					<span class="light">{Array}</span>
					<b>searchLine</b>(fmi, fma, fix, interval, dir, num_components, dataX, dataY)
...
fulfilling the given equation.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Function}</span> <b>fmi</b>
									
								</dt>
								<dd>Minimization function</dd>
							
								<dt>
									<span class="light fixedFont">{Function}</span> <b>fma</b>
									
								</dt>
								<dd>Maximization function</dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>fix</b>
									
								</dt>
								<dd>Value of the fixed variable</dd>
							
								<dt>
									<span class="light fixedFont">{Array}</span> <b>interval</b>
									
								</dt>
								<dd>Search interval of the free variable</dd>
							
								<dt>
									<span class="light fixedFont">{String}</span> <b>dir</b>
									
								</dt>
								<dd>'vertical' or 'horizontal'</dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>num_components</b>
									
								</dt>
								<dd>Number of components before search</dd>
					...
					<a name="traceComponent"> </a>
					<div class="fixedFont">&lt;private&gt; 

					
					<b>traceComponent</b>(u0)
...
the same initial point. Finally, the two components are glued together.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array}</span> <b>u0</b>
									
								</dt>
								<dd>Initial point in homogenous coordinates [1, x, y].</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd>Array [dataX, dataY] containing a new component.</dd>
...
Eugene L. Allgower, Kurt Georg: <i>Introduction to Numerical Continuation methods.</i>
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Starting point in homogenous coordinates  [1, x, y].</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd>Array [pathX, pathY, loop_closed] or []</dd>
...
See (7.2.3) in Allgower, Georg.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array}</span> <b>u1</b>
