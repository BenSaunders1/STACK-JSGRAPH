				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Util.Base64.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Util.Base64.<b><a href="../symbols/JXG.Util.Base64.html#._getByte">_getByte</a></b>(s, i)
								</div>
								<div class="description">Extracts one byte from a string and ensures the result is less than or equal to 255.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Util.Base64.<b><a href="../symbols/JXG.Util.Base64.html#._getIndex">_getIndex</a></b>(s, i)
								</div>
								<div class="description">Determines the index of a base64 character in the base64 alphabet.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.Util.Base64.</span><b>_getByte</b>(s, i)
					...
					<div class="description">
						Extracts one byte from a string and ensures the result is less than or equal to 255.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Number}</span> <= 255</dd>
					...
					<span class="light">{Number}</span>
					<span class="light">JXG.Util.Base64.</span><b>_getIndex</b>(s, i)
					...
					<div class="description">
						Determines the index of a base64 character in the base64 alphabet.
							...
							<dt class="heading">Throws:</dt>
								...
								<dd>If the character can not be found in the alphabet.</dd>
