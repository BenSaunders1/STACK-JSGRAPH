...
Transformations acting on texts and images are considered to be affine, i.e. b and c are ignored.
						...
						<dl class="detailList">
							...
							<dt>
                                    ...
                                    <span class="light fixedFont">{numbers|functions}</span> <b>parameters</b><br />
                                    <br />
                                
							</dt>
								<dd>The parameters depend on the transformation type, supplied as attribute 'type'.
...
( g  h  i )   ( y )
						...
						<dt class="heading">See:</dt>
							...
							<dd><a href="../symbols/JXG.Transformation.html#setMatrix">JXG.Transformation#setMatrix</a></dd>
...
<script type="text/javascript">
    ...
    rot.bindTo(sq.slice(1));
				...
				<pre class="code">// Text transformation
