...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class Riemannsum.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/Riemannsum.html#Value">Value</a></b>()
								</div>
								<div class="description">Returns the value of the Riemann sum, i.e.</div>
							</td>
						</tr>
					...
					<div class="description">
						Returns the value of the Riemann sum, i.e. the sum of the (signed) areas of the rectangles.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Number}</span> value of Riemann sum.</dd>
