...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Math.Quadtree</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Math.Quadtree</strong><br /><br /></p>
...
<!-- ============================== constructor summary ==================== -->
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Math.Quadtree.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Quadtree.html#constructor">JXG.Math.Quadtree</a></b>(bbox, config, parent)
							</div>
							<div class="description">Instantiate a new quadtree.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== properties summary ===================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the fields documented in the class JXG.Math.Quadtree.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Quadtree.html#_query">_query</a></b>
								</div>
								<div class="description">Internal _query method that lacks adjustment of the parameter.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								JXG.Math.Quadtree.<b><a href="../symbols/JXG.Math.Quadtree.html#.config">config</a></b>
								</div>
								<div class="description">Configuration object for quadtree.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Quadtree.html#northEast">northEast</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Quadtree.html#northWest">northWest</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Quadtree.html#parent">parent</a></b>
								</div>
								<div class="description">Parent quadtree or null if there is not parent.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Quadtree.html#points">points</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Quadtree.html#query">query</a></b>
								</div>
								<div class="description">Retrieve the smallest quad tree that contains the given coordinate pair.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Quadtree.html#southEast">southEast</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Quadtree.html#southWest">southWest</a></b>
								</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Math.Quadtree.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.Quadtree.html#contains">contains</a></b>(x, y)
								</div>
								<div class="description">Checks if the given coordinates are inside of the boundaries of the quadtree.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.Quadtree.html#getAllPoints">getAllPoints</a></b>()
								</div>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.Quadtree.html#hasPoint">hasPoint</a></b>(x, y, tol)
								</div>
								<div class="description">Check if the quadtree has a point which is inside of a sphere of
radius tol around [x, y].</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.Quadtree.html#insert">insert</a></b>(p)
								</div>
								<div class="description">Insert a new point into this quadtree if it is inside of
the quadtree's boundaries.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.Quadtree.html#subdivide">subdivide</a></b>()
								</div>
								<div class="description">Subdivide the quadtree.</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>JXG.Math.Quadtree</b>(bbox, config, parent)
				</div>
					...
					Instantiate a new quadtree.
						...
						<dl class="detailList">
							...
							<dt>
								...
								<dd>Configuration object. Default value: to {capacity: 10}</dd><br /><br />
							...
							<dt>
								...
								<dd>Parent object or null if root.</dd><br /><br />
...
<!-- ============================== field details ========================== -->
				...
				<div class="sectionTitle">
					...
					<span class="light">{Boolean|JXG.Quadtree}</span>
					<b>_query</b>
					...
					<span class="light">JXG.Math.Quadtree.</span><b>config</b>
...
the quadtree's boundaries.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Boolean}</span> true if insert succeeded, false otherwise.</dd>
