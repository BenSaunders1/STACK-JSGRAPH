					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								...
								<div class="description">Copy array, either scrCoords or usrCoords
...
typed arrays.</div>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Coords.html#isReal">isReal</a></b>()
								</div>
								<div class="description">Test if one of the usrCoords is NaN or the coordinates are infinite.</div>
							</td>
						</tr>
					...
					Constructs a new Coordinates object.
						...
						<dl class="detailList">
							...
							<dt>
    								...
    								<span class="light fixedFont">{Boolean}</span>  <b>emitter</b>
...
typed arrays.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Either 'scrCoords' or 'usrCoords'</dd>
					...
					<div class="description">
						Test if one of the usrCoords is NaN or the coordinates are infinite.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Boolean}</span> true if the coordinates are finite, false otherwise.</dd>
