...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Expect</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Expect</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_utils_expect.js.html">expect.js</a>.
...
<!-- ============================== constructor summary ==================== -->
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Expect.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Expect.html#constructor">JXG.Expect</a></b>
							</div>
							<div class="description">The JXG.Expect namespace provides method to normalize access on coordinates,
i.e.</div>
						</td>
					</tr>
				</tbody>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Expect.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Expect.<b><a href="../symbols/JXG.Expect.html#.coords">coords</a></b>(c, copy)
								</div>
								<div class="description">Normalize points and coord objects into a coord object.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Expect.<b><a href="../symbols/JXG.Expect.html#.coordsArray">coordsArray</a></b>(c, copy)
								</div>
								<div class="description">Normalize points, coordinate arrays and coord objects into a coordinate array.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Expect.<b><a href="../symbols/JXG.Expect.html#.each">each</a></b>(a, format, copy)
								</div>
								<div class="description">Apply an expect method on every element of an array.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.Expect.</span><b>coords</b>(c, copy)
					...
					<div class="description">
						Normalize points and coord objects into a coord object.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.Point.html">JXG.Point</a>|<a href="../symbols/JXG.Coords.html">JXG.Coords</a>}</span> <b>c</b>
									
								</dt>
								<dd></dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>copy</b>
									<i>Optional, Default: false</i>
								</dt>
								<dd>Return a copy, not a reference</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{<a href="../symbols/JXG.Coords.html">JXG.Coords</a>}</span> </dd>
					...
					<a name=".coordsArray"> </a>
					<div class="fixedFont">&lt;static&gt; 

					<span class="light">{Array}</span>
					<span class="light">JXG.Expect.</span><b>coordsArray</b>(c, copy)
					...
					<div class="description">
						Normalize points, coordinate arrays and coord objects into a coordinate array.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{<a href="../symbols/JXG.Point.html">JXG.Point</a>|<a href="../symbols/JXG.Coords.html">JXG.Coords</a>|Array}</span> <b>c</b>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Array}</span> Homogeneous coordinates</dd>
					...
					<span class="light">{Array}</span>
					<span class="light">JXG.Expect.</span><b>each</b>(a, format, copy)
					...
					<div class="description">
						Apply an expect method on every element of an array.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{function}</span> <b>format</b>
