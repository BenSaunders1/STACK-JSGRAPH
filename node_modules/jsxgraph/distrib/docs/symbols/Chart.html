...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - Chart</title>
...
<p>
 <strong><a href="../symbols/JXG.GeometryElement.html">JXG.GeometryElement</a></strong><br />&nbsp;&nbsp;&nbsp;&#x21b3; <strong><a href="../symbols/JXG.Chart.html">JXG.Chart</a></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>Chart</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
                ...
                <br />Extends
                    <a href="../symbols/JXG.Chart.html">JXG.Chart</a>.
                
			</p>

<!-- ============================== constructor summary ==================== -->
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class Chart.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/Chart.html#constructor">Chart</a></b>
							</div>
				...
				<div class="description">
						...
						<dl class="detailList">
							...
							<dt>
                                    ...
                                    <span class="light fixedFont">{Array}</span> <b>x</b><br />
                                    <br />
                                
							</dt>
								<dd>Array of x-coordinates (default case, see below for alternatives)</dd><br /><br />
						
							<dt>
                                
                                
                                    <span class="light fixedFont">{Array}</span> <b>y</b><br />
                                    <br />
                                
							</dt>
								<dd>Array of y-coordinates (default case, see below for alternatives)
<p>
...
'bar', 'fit', 'line',  'pie', 'point', 'radar', 'spline'.</dd><br /><br />
						...
						<dt class="heading">See:</dt>
							...
							<dd><a href="../symbols/JXG.Chart.html#drawBar">JXG.Chart#drawBar</a></dd>
						
							<dd><a href="../symbols/JXG.Chart.html#drawFit">JXG.Chart#drawFit</a></dd>
						
							<dd><a href="../symbols/JXG.Chart.html#drawLine">JXG.Chart#drawLine</a></dd>
						
							<dd><a href="../symbols/JXG.Chart.html#drawPie">JXG.Chart#drawPie</a></dd>
						
							<dd><a href="../symbols/JXG.Chart.html#drawPoints">JXG.Chart#drawPoints</a></dd>
						
							<dd><a href="../symbols/JXG.Chart.html#drawRadar">JXG.Chart#drawRadar</a></dd>
						
							<dd><a href="../symbols/JXG.Chart.html#drawSpline">JXG.Chart#drawSpline</a></dd>
				...
				<pre class="code">  board = JXG.JSXGraph.initBoard('jxgbox', {boundingbox:[-0.5,8,9,-2],axis:true});
    ...
    (function() {
        var board = JXG.JSXGraph.initBoard('JXG1528c395-9fa4-4210-ada6-7fc5652ed920',
            {boundingbox: [-0.5,8,9,-2], axis: true, showcopyright: false, shownavigation: false});
				...
				<pre class="code">  board = JXG.JSXGraph.initBoard('jxgbox', {boundingbox: [-1, 9, 13, -3], axis:true});
    ...
    (function() {
        var board = JXG.JSXGraph.initBoard('JXG22deb158-48c6-41c3-8157-b88b4b968a55',
            {boundingbox: [-1, 9, 13, -3], axis: true, showcopyright: false, shownavigation: false});
				...
				<pre class="code">        var dataArr = [4, 1.2, 3, 7, 5, 4, 1.54, function () { return 2; }];
    ...
    (function() {
        var board = JXG.JSXGraph.initBoard('JXG1180b7dd-b048-436a-a5ad-87ffa82d5aff',
            ...
            var a = board.create('chart', dataArr, {
				...
				<pre class="code">            board = JXG.JSXGraph.initBoard('jxgbox', {boundingbox: [-12, 12, 20, -12], axis: false});
            board.suspendUpdate();
