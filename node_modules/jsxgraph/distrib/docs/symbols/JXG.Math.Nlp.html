...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.Math.Nlp</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.Math.Nlp</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_math_nlp.js.html">nlp.js</a>.
...
<!-- ============================== constructor summary ==================== -->
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.Math.Nlp.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Math.Nlp.html#constructor">JXG.Math.Nlp</a></b>
							</div>
							<div class="description">The JXG.Math.Nlp namespace holds numerical algorithms for non-linear optimization.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Math.Nlp.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Nlp.<b><a href="../symbols/JXG.Math.Nlp.html#.cobylb">cobylb</a></b>(calcfc, n, m, mpp, x, rhobeg, rhoend, iprint, maxfun, testForRoundingErrors)
								</div>
								<div class="description">JavaScript implementation of the non-linear optimization method COBYLA.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.Math.Nlp.<b><a href="../symbols/JXG.Math.Nlp.html#.FindMinimum">FindMinimum</a></b>(calcfc, n, m, x, rhobeg, rhoend, iprint, maxfun, testForRoundingErrors)
								</div>
								<div class="description">Minimizes the objective function F with respect to a set of inequality constraints CON,
and returns the optimal variable array.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.Math.Nlp.</span><b>cobylb</b>(calcfc, n, m, mpp, x, rhobeg, rhoend, iprint, maxfun, testForRoundingErrors)
					...
					<div class="description">
						JavaScript implementation of the non-linear optimization method COBYLA.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Function}</span> <b>calcfc</b>
								...
								<dt>
									<span class="light fixedFont">{Number}</span> <b>mpp</b>
								...
								<dt>
									<span class="light fixedFont">{Number}</span> <b>rhobeg</b>
									
								</dt>
								<dd></dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>rhoend</b>
									
								</dt>
								<dd></dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>iprint</b>
									
								</dt>
								<dd></dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>maxfun</b>
									
								</dt>
								<dd></dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>testForRoundingErrors</b>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Number}</span> Exit status of the COBYLA2 optimization</dd>
					...
					<a name=".FindMinimum"> </a>
					<div class="fixedFont">&lt;static&gt; 

					<span class="light">{Number}</span>
					<span class="light">JXG.Math.Nlp.</span><b>FindMinimum</b>(calcfc, n, m, x, rhobeg, rhoend, iprint, maxfun, testForRoundingErrors)
...
Calls JXG.Math.Nlp#cobylb.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Interface implementation for calculating objective function and constraints.</dd>
								...
								<dd>On input initial values of the variables (zero-based array). On output
optimal values of the variables obtained in the COBYLA minimization.</dd>
							
								<dt>
									<b>rhobeg</b>
									
								</dt>
								<dd>Initial size of the simplex.</dd>
							
								<dt>
									<b>rhoend</b>
									
								</dt>
								<dd>Final value of the simplex.</dd>
							
								<dt>
									<b>iprint</b>
									
								</dt>
								<dd>Print level, 0 <= iprint <= 3, where 0 provides no output and
3 provides full output to the console.</dd>
							
								<dt>
									<b>maxfun</b>
									
								</dt>
								<dd>Maximum number of function evaluations before terminating.</dd>
							
								<dt>
									<b>testForRoundingErrors</b>
									<i>Optional, Default: false</i>
								</dt>
								<dd></dd>
