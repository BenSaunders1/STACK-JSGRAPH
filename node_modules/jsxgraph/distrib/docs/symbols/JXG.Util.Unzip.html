...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.Util.Unzip.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Util.Unzip.html#-nextFile">nextFile</a></b>()
								</div>
								<div class="description">nextFile:
Extract the next file from the compressed archive.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Util.Unzip.html#-skipdir">skipdir</a></b>()
								</div>
								<div class="description">Test if the end of the files' data part of the archive has baseElement
reached.</div>
							</td>
						</tr>
...
Calls skipdir() to proceed recursively.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Boolean}</span> false if the end of files' data section has baseElement
reached. Then, then all recursive functions are stopped immediately.</dd>
...
reached. If not, uncompressing is resumed.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Boolean}</span> true if the end of the files' data sections have
been reached.</dd>
