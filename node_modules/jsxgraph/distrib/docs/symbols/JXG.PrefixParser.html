...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JSXGraph Reference - JXG.PrefixParser</title>
...
<p>
 <strong></strong><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x21b3; <strong>JXG.PrefixParser</strong><br /><br /></p>
...
<!-- ============================== class summary ========================== -->
			<p class="description">
					...
					<br /><br /><i>Defined in: </i> <a href="../symbols/src/src_parser_prefix.js.html">prefix.js</a>.
...
<!-- ============================== constructor summary ==================== -->
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class JXG.PrefixParser.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.PrefixParser.html#constructor">JXG.PrefixParser</a></b>
							</div>
							<div class="description">Prefix expression parser, i.e.</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class JXG.PrefixParser.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.PrefixParser.<b><a href="../symbols/JXG.PrefixParser.html#.dimension">dimension</a></b>(term)
								</div>
								<div class="description">Determine the dimension of the resulting value, i.e.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">JXG.PrefixParser.<b><a href="../symbols/JXG.PrefixParser.html#.getParents">getParents</a></b>(term)
								</div>
								<div class="description">Determine parent elements of a prefix expression.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.PrefixParser.<b><a href="../symbols/JXG.PrefixParser.html#.parse">parse</a></b>(term, action)
								</div>
								<div class="description">Parse a prefix expression and apply an action.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JXG.PrefixParser.<b><a href="../symbols/JXG.PrefixParser.html#.toPrefix">toPrefix</a></b>(term)
								</div>
								<div class="description">Convert a prefix expression into a new prefix expression in which
JSXGraph elements have been replaced by their ids.</div>
							</td>
						</tr>
...
see <a href="../symbols/Measurement.html">Measurement</a>.
...
// Valid prefix expression:  ['+', ['Radius', ci], ['L', seg]]</pre>
				
				<pre class="code">var ang = board.create('angle', [[4, 0], [0, 0], [2, 2]]);
// Valid prefix expression:  ['V', ang, 'degrees']);</pre>
...
<!-- ============================== method details ========================= -->
				...
				<div class="sectionTitle">
					...
					<span class="light">JXG.PrefixParser.</span><b>dimension</b>(term)
...
This overrules the computed dimension.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array|Number}</span> <b>term</b>
									
								</dt>
								<dd>Prefix expression</dd>
					...
					<span class="light">JXG.PrefixParser.</span><b>getParents</b>(term)
					...
					<span class="light">JXG.PrefixParser.</span><b>parse</b>(term, action)
					...
					<div class="description">
						Parse a prefix expression and apply an action.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Determines what to do. So far, the only
action available is 'execute', which evaluates the expression.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Number}</span> What ever the action does.</dd>
					...
					<span class="light">JXG.PrefixParser.</span><b>toPrefix</b>(term)
