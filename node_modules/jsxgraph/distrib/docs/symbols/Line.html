					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								...
								<div class="description">Configure the arrow head at the position of its first point or the corresponding
...
<pre>
{
     type: 1, // possible values are 1, 2, .</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								...
								<div class="description">Configure the arrow head at the position of its second point or the corresponding
intersection with the canvas border.</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/Line.html#margin">margin</a></b>
								</div>
								<div class="description">This number (pixel value) controls where infinite lines end at the canvas border.</div>
							</td>
						</tr>
...
<a href="../symbols/Point.html#snapSizeX">Point#snapSizeX</a> and <a href="../symbols/Point.html#snapSizeY">Point#snapSizeY</a>.</div>
						...
						<tr>
							...
							<td class="nameDescription">
								...
								<div class="description">If set to true, <a href="../symbols/Line.html#firstArrow">Line#firstArrow</a> is set to true and the point is visible,
the arrow head will just touch the circle line of the start point of the line.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								...
								<div class="description">If set to true, <a href="../symbols/Line.html#lastArrow">Line#lastArrow</a> is set to true and the point is visible,
the arrow head will just touch the circle line of the start point of the line.</div>
							</td>
						</tr>
...
It is possible to provide a function returning an array or a point, instead of providing an array or a point.</dd><br /><br />
							...
							<dt>
                                    ...
                                    <span class="light fixedFont">{Number|function}</span> <b>a</b><br /><span class="light fixedFont">{Number|function}</span> <b>b</b><br /><span class="light fixedFont">{Number|function}</span> <b>c</b><br />
                                    <br />
...
It is possible to provide three functions returning numbers, too.</dd><br /><br />
...
<script type="text/javascript">
    ...
    var l2 = board.create('line', [l1, t]);
				...
				<pre class="code">//create line between two points
...
An arrow head can be turned off with line.setAttribute({firstArrow: false}).
					...
					<pre class="code">    board.options.line.lastArrow = false;
        ...
        board.create('segment', [[-5,-2], [3,-2]], {firstArrow: {type: 7}, point1: {name: 'type:7'}});
					...
					<div class="description">
						Attributes for the line label.
							...
							<dd><a href="../symbols/Label.html">Label</a></dd>
...
An arrow head can be turned off with line.setAttribute({lastArrow: false}).
					...
					<pre class="code">    var p1 = board.create('point', [-5, 2], {size:1});
        ...
        var li = board.create('segment', ['A','B'],
            {name:'seg',
             ...
             firstArrow: {type: 3, size: 8}
					...
					<pre class="code">    board.options.line.strokeWidth = 4;
    board.options.line.highlightStrokeWidth = 4;
...
Otherwise it ends at point2.
					...
					<div class="description">
						If set to true, <a href="../symbols/Line.html#firstArrow">Line#firstArrow</a> is set to true and the point is visible,
the arrow head will just touch the circle line of the start point of the line.
					...
					<div class="description">
						If set to true, <a href="../symbols/Line.html#lastArrow">Line#lastArrow</a> is set to true and the point is visible,
the arrow head will just touch the circle line of the start point of the line.
