...
<a href="symbols/Line.html">Line</a> with <a href="symbols/Line.html#straightFirst">Line#straightFirst</a>
and <a href="symbols/Line.html#straightLast">Line#straightLast</a> properties set to false and <a href="symbols/Line.html#lastArrow">Line#lastArrow</a> set to true.
			</div>
			<hr />
			...
			<div>
				...
				An arrow parallel is a segment with an arrow attached which is parallel through a given segment, given by its defining two points,
through a given point.
			...
			<div>
				<h2><a href="symbols/Axes3D.html">Axes3D</a></h2>
			...
			<div>
				<h2><a href="symbols/Axis3D.html">Axis3D</a></h2>
			...
			<div>
				...
				Bisector lines are similar to <a href="symbols/Bisector.html">Bisector</a> but take two lines as parent elements.
			</div>
			<hr />
			...
			<div>
				<h2><a href="symbols/Boxplot.html">Boxplot</a></h2>
				Box plot curve.
			</div>
			<hr />
...
form button element.
			...
			<div>
				<h2><a href="symbols/Chart.html">Chart</a></h2>
...
form checkbox element.
			...
			<div>
				<h2><a href="symbols/Circle3D.html">Circle3D</a></h2>
				This element is used to provide a constructor for a circle.
			</div>
			<hr />
...
<p><i>Ax<sup>2</sup>+ Bxy+Cy<sup>2</sup> + Dx + Ey + F = 0</i></p>.
			...
			<div>
				<h2><a href="symbols/Curve3D.html">Curve3D</a></h2>
			...
			<div>
				<h2><a href="symbols/CurveDifference.html">CurveDifference</a></h2>
			...
			<div>
				<h2><a href="symbols/CurveIntersection.html">CurveIntersection</a></h2>
			...
			<div>
				<h2><a href="symbols/CurveUnion.html">CurveUnion</a></h2>
...
the (numerical) derivative of a given curve.
			...
			<div>
				<h2><a href="symbols/ForeignObject.html">ForeignObject</a></h2>
...
set to x.
			...
			<div>
				<h2><a href="symbols/Functiongraph3D.html">Functiongraph3D</a></h2>
 ...
 group.
			...
			<div>
				<h2><a href="symbols/ImplicitCurve.html">ImplicitCurve</a></h2>
...
HTML form input element.
			...
			<div>
				<h2><a href="symbols/IntersectionCircle3D.html">IntersectionCircle3D</a></h2>
			...
			<div>
				<h2><a href="symbols/IntersectionLine3D.html">IntersectionLine3D</a></h2>
			...
			<div>
				<h2><a href="symbols/Legend.html">Legend</a></h2>
			...
			<div>
				<h2><a href="symbols/Line3D.html">Line3D</a></h2>
...
180 degrees (pi radians).
			...
			<div>
				<h2><a href="symbols/Measurement.html">Measurement</a></h2>
				Measurement element.
			</div>
			<hr />
			...
			<div>
				<h2><a href="symbols/Mesh3D.html">Mesh3D</a></h2>
			...
			<div>
				<h2><a href="symbols/Metapostspline.html">Metapostspline</a></h2>
...
180 degrees (pi radians).
			...
			<div>
				...
				A parallel is a line through a given point with the same slope as a given line or
the line through two given point.
			...
			<div>
				<h2><a href="symbols/Parallelogram.html">Parallelogram</a></h2>
			...
			<div>
				<h2><a href="symbols/ParametricSurface3D.html">ParametricSurface3D</a></h2>
			...
			<div>
				<h2><a href="symbols/Point3D.html">Point3D</a></h2>
...
<ul>
   ...
   <li> a function returning a list of coordinate arrays.
			...
			<div>
				<h2><a href="symbols/PolygonalChain.html">PolygonalChain</a></h2>
...
<ul>
   ...
   <li> a function returning a list of coordinate arrays.
			...
			<div>
				<h2><a href="symbols/Slopefield.html">Slopefield</a></h2>
				Slope field.
			</div>
			<hr />
			...
			<div>
				<h2><a href="symbols/Smartlabel.html">Smartlabel</a></h2>
				Smart label.
			</div>
			<hr />
			...
			<div>
				<h2><a href="symbols/Sphere3D.html">Sphere3D</a></h2>
			...
			<div>
				<h2><a href="symbols/TangentTo.html">TangentTo</a></h2>
			...
			<div>
				<h2><a href="symbols/Text3D.html">Text3D</a></h2>
			...
			<div>
				<h2><a href="symbols/Ticks3D.html">Ticks3D</a></h2>
			...
			<div>
				<h2><a href="symbols/Vectorfield.html">Vectorfield</a></h2>
				Vector field.
			</div>
			<hr />
			...
			<div>
				<h2><a href="symbols/Vectorfield3D.html">Vectorfield3D</a></h2>
				3D vector field.
			</div>
			<hr />
			...
			<div>
				<h2><a href="symbols/View3D.html">View3D</a></h2>
...
elements, managing mouse and touch events, etc.
			...
			<div>
				<h2><a href="symbols/JXG.Board.infobox.html">JXG.Board.infobox</a></h2>
			...
			<div>
				...
				Namespace for the complex number arithmetic functions, see also <a href="symbols/JXG.Complex.html">JXG.Complex</a>.
			</div>
			<hr />
			...
			<div>
				<h2><a href="symbols/JXG.Chart.html">JXG.Chart</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Circle3D.html">JXG.Circle3D</a></h2>
			...
			<div>
				...
				This class is for calculating with complex numbers, see also <a href="symbols/JXG.C.html">JXG.C</a> for more methods.
			</div>
			<hr />
			...
			<div>
				<h2><a href="symbols/JXG.Curve3D.html">JXG.Curve3D</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Expect.html">JXG.Expect</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.ForeignObject.html">JXG.ForeignObject</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.GeometryElement3D.html">JXG.GeometryElement3D</a></h2>
...
to load, save, create and free a board.
			...
			<div>
				<h2><a href="symbols/JXG.Legend.html">JXG.Legend</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Line3D.html">JXG.Line3D</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Math.BoxQuadtree.html">JXG.Math.BoxQuadtree</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Math.Clip.html">JXG.Math.Clip</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Math.Extrapolate.html">JXG.Math.Extrapolate</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Math.ImplicitPlot.html">JXG.Math.ImplicitPlot</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Math.IntervalArithmetic.html">JXG.Math.IntervalArithmetic</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Math.Metapost.html">JXG.Math.Metapost</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Math.Nlp.html">JXG.Math.Nlp</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Math.Plot.html">JXG.Math.Plot</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Math.ProbFuncs.html">JXG.Math.ProbFuncs</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Math.Quadtree.html">JXG.Math.Quadtree</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Plane3D.html">JXG.Plane3D</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Point3D.html">JXG.Point3D</a></h2>
...
to draw and to interactact with a polygon.
			...
			<div>
				<h2><a href="symbols/JXG.Polygon3D.html">JXG.Polygon3D</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.PrefixParser.html">JXG.PrefixParser</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Sphere3D.html">JXG.Sphere3D</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Surface3D.html">JXG.Surface3D</a></h2>
			...
			<div>
				<h2><a href="symbols/JXG.Text3D.html">JXG.Text3D</a></h2>
				Creates a new 3D point object.
			</div>
			<hr />
...
Class for gunzipping, unzipping and base64 decoding of files.
			...
			<div>
				<h2><a href="symbols/JXG.View3D.html">JXG.View3D</a></h2>
		...
		<div class="fineprint" style="clear:both">
			...
			Documentation generated by <a href="https://www.npmjs.com/package/jsdoc-toolkit" target="_blankt">JsDoc Toolkit</a> 2.4.0 on Wed Oct 23 2024 15:44:17 GMT+0200 (Mitteleuropäische Sommerzeit)
		</div>
	</body>
</html>
